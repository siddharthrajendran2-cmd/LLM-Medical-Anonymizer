from webapp.confidence_scoring import process_document_with_confidence, calculate_privacy_risk, get_entity_statistics
...
def llm_download():
    ...
    if job.done():
        ...
        return redirect(url_for('llm_processing.llm_results'))
@llm_processing.route('/privacy-dashboard')
